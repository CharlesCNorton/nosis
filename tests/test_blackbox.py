...
class TestVendorPrimitiveNames:
    def test_known_primitives(self):
        for name in ("USRMCLK", "EHXPLLL", "DCCA", "OSCG", "LUT4"):
            assert name in ECP5_BLACKBOX_NAMES

    def test_user_module_not_primitive(self):
        assert "my_custom_module" not in ECP5_BLACKBOX_NAMES
