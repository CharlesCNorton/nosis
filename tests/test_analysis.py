...
def test_routing_estimate_grows_with_size():
    """Larger designs should have a higher routing delay estimate."""
    ...
    assert (estimate_routing(big).max_routing_delay_ns
            > estimate_routing(small).max_routing_delay_ns)
