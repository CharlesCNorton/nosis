...
# ECP5 vendor primitives that the frontend must not lower — their
# instantiations pass through as opaque cells. Kept as a literal set
# (not derived from the registry below) because it also includes cells
# like LUT4 that designs may instantiate directly.
