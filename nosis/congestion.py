...
metrics: fanout distribution and net degree histogram. High fanout nets
(one driver, many consumers) create routing pressure. The congestion
score is derived from the fanout distribution — designs with many
